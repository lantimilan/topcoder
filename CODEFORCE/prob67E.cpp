// =========================================================
// 
//       Filename:  prob67E.cpp
// 
//    Description:  E. Ship's Shortest Path
// 
//        Version:  1.0
//        Created:  04/13/2011 08:52:37 PM
//       Revision:  none
//       Compiler:  g++
// 
...
void solve()
{
    ...
    for(int i=0; i<n; ++i)
    {
        ...
        if (segmentIntersect(vp[i],vp[next],start,end))
        {
            ...
            pt2line(vp[i],vp[next],A1,B1,C1);
            pt2line(start,end,A2,B2,C2);
            lineIntersect(A1,B1,C1,A2,B2,C2,pts[cnt]);
            if (cnt==0) { x[cnt++]=i; } // first intersection
            else if (cnt==1) { // second intersection
                if (pts[0] == pts[1]) { /* do nothing */ }
                else { x[cnt++]=i; break; }
            }
        }
    }
...
/* ***************
 * 387422        Apr 14, 2011 8:38:16 AM    lantimilan        E - Ships Shortest
 * Path      GNU C++     Accepted        30 ms       1400 KB
 * 387405   Apr 14, 2011 8:19:18 AM     lantimilan  E - Ships Shortest Path
 * GNU C++  Wrong answer on test 13     30 ms   1400 KB
 * 387402   Apr 14, 2011 8:16:41 AM     lantimilan  E - Ships Shortest Path
 * GNU C++  Wrong answer on test 3  30 ms   1400 KB 
 * */
